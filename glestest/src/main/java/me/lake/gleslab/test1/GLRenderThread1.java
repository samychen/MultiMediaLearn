 ...
 */
public class GLRenderThread1 extends Thread {
    EGL10 mEgl;
    ...
    public GLRenderThread1(Context context, SurfaceTexture surfaceTexture) {
...
//        GLES20.glDisableVertexAttribArray(aTextureCoordLocation);
    ...
    public void run() {
        ...
        while (!quit) {
             ...
             */
            drawFrame();
            //一帧绘制完成后调用eglSwapBuffers来显示 GPU渲染完数据在显存，回传内存的唯一方式glReadPixels函数
